...
/// ~/Library/Application Support/Aeroshot/History.
@MainActor
final class HistoryStore: ObservableObject {
    ...
    let directory: URL = {
        ...
        let dir = base.appendingPathComponent("Aeroshot/History", isDirectory: true)
        if fileManager.fileExists(atPath: legacy.path), !fileManager.fileExists(atPath: dir.path) {
            try? fileManager.createDirectory(at: dir.deletingLastPathComponent(), withIntermediateDirectories: true)
